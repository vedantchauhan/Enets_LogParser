 ...
 * @author Vedant
 */
public class Enets_LogParser {


    public static void main(String[] args) throws IOException {

        MongoCredential credential = MongoCredential.createCredential("enets_audit", "admin", "megHealth@unimelb".toCharArray());
        //  MongoClient ip and port no
        MongoClient mongoClient = new MongoClient(new ServerAddress("localhost", 27017), Arrays.asList(credential));

        // Get handle to "ensat"
        DB db = mongoClient.getDB("enets");
        // Get collection ensatHistory
        DBCollection collection = db.getCollection("enetsHistory");
        // Get collection ensatLogInfo
        DBCollection collectionInfo = db.getCollection("enetsLogInfo");
        ...
        EnetsBean ensat = new EnetsBean();
        EnetsBean ensat1 = new EnetsBean();
        ...
        try {
            ...
            if (!tableValues.isEmpty()) {
                ...
                for (int j = 0; j < index.size() - 1; j++) {
                    ...
                    ensat.setEnets_id(subList1.get(0));
                    ...
                    for (int k = 3; k < subList1.size(); k = k + 3) {
                        ...
                        DBObject result = new BasicDBObject()
                                .append("ensat_id", ensat.getEnets_id())
                    ...
                    if (subList2.isEmpty()) {
                        ...
                        // adding data to bean
                        ensat1.setEnets_id(subList2.get(0));
                        ...
                        for (int k = 3; k < subList2.size(); k = k + 3) {
                            ...
                            DBObject result1 = new BasicDBObject()
                                    .append("ensat_id", ensat1.getEnets_id())
